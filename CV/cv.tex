...
\begin{longtable}{p{0.7cm}p{15cm}}
   & \textbf{Popov, V.} (preprint). $m$-Bell and $m$-Stirling numbers: Iterated binomial transforms, hyper-Bessel functions, and moments of the Conway--Maxwell--Poisson distribution. Preprint available at \url{https://arxiv.org/abs/2608.12011}                                          \\[6pt]
   &                                                                                                                                                                                                                                                                                         \\
   & \textbf{Popov, V.} \& Oberauer, K. (submitted). How to build an observatory for the mind. Preprint available at \url{https://doi.org/10.31234/osf.io/hmu9r}                                                                                                                             \\[6pt]
   &                                                                                                                                                                                                                                                                                         \\
   & van Dongen, N. N., Glöckner, A., Musfeld, P., Sarafoglou, A., Borsboom, D., … \textbf{Popov, V.}, … Yuan, L. (submitted). The state and status of theory in psychological science. Preprint available at \url{https://doi.org/10.31234/osf.io/2fjx4_v2}                                 \\[6pt]
   &                                                                                                                                                                                                                                                                                         \\
   & Barthelmes, B. T. \& \textbf{Popov, V.} (submitted). Towards measuring the theory crisis in psychology: An LLM-assisted discourse-analysis approach. Preprint available at \url{https://doi.org/10.31234/osf.io/4y2sp_v2}                                                               \\[6pt]
   &                                                                                                                                                                                                                                                                                         \\
   & Greeno, D. J., Morey, C. C., \& \textbf{Popov, V.} (submitted). Encoding serial items depletes cognitive resource: An adversarial comparison of reconfiguration and resource-depletion accounts of working memory. Preprint available at \url{https://doi.org/10.31234/osf.io/vj8pn_v3} \\[6pt]
   &                                                                                                                                                                                                                                                                                         \\
   & \textbf{Popov, V.} (under review). Cognitive resources can be intentionally released when processed information becomes irrelevant: Insights from the primacy effect in working memory. Preprint available at \url{https://osf.io/preprints/psyarxiv/gct58}                             \\[6pt]
   &                                                                                                                                                                                                                                                                                         \\
   & \textbf{Popov, V.} (under revision). If God Handed Us the Ground-Truth Theory of Memory, How Would We Recognize It? Preprint available at \url{https://osf.io/preprints/psyarxiv/ay5cm}                                                                                                 \\
   \end{longtable}
